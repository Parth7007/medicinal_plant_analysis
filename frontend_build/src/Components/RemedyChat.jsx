...
const RemedyChat = () => {
  ...
  return (
    <div
      className="relative min-h-screen w-full overflow-x-hidden flex flex-col items-center pt-20 pb-12 px-4 bg-cover bg-center bg-fixed text-white"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl">
        ...
        >
          <div className="flex gap-3 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-2 shadow-2xl focus-within:border-green-400/50 transition-colors w-full overflow-hidden">
            <input
              type="text"
              value={query}
              ...
              className="flex-1 min-w-0 h-14 text-base bg-transparent text-white placeholder-gray-400 outline-none"
